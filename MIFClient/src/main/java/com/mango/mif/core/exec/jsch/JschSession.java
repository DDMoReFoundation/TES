...
/**
 * A session:- basically a collection of everything we need to run a command on either a local or a remote
 * machine.
 */
public class JschSession {
    ...
    public InvokerResult run(String commandLine, String input) throws ExecutionException {
        ...
        try {
            ...
            // We must always set the standard input, even if there isn't any.
            // This is because if we don't set it, and a command tries to read
            // its standard input, it will hang (and not get an immediate EOF
            // as I had hoped).  I know this because I've just been stupid
            // enough to accidentally try it and spend an hour wondering what

 ...
 *******************************************************************************/
package com.mango.mif.helloworld.rest;
...
public class ConnectorServiceImpl implements ConnectorService {
	...
	public String doSomething(@PathParam("myParam") String myParam) throws MIFException {
		...
		final CommandExecutionConnector connector = (CommandExecutionConnector) this.connectorsRegistry.getConnectorById("HELLO-WORLD");

...
REM java -cp %home%\jars\converter-toolbox-0.0.1-SNAPSHOT.jar:%home%\jars\libPharmml.jar:%home%\jars\converter-pharmml2nmtran-0.0.1-SNAPSHOT-jar-with-dependencies.jar eu.ddmore.convertertoolbox.cli.Main %*

xcopy /s/e/y "%home%\mockResult" "%2"

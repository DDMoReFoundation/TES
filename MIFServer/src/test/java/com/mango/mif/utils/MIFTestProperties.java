 ...
 */
public class MIFTestProperties {
    private final static Logger LOG = Logger.getLogger(MIFTestProperties.class);
    /**
     * Other user name
     */
     ...
     * Other user password
     */
    public final static String MIF_OTHER_CLIENT_PASSWORD = "mif.other.client.password";
    /**
     * MIF client user name
     */
    public final static String MIF_CLIENT_USER_NAME = "mif.client.userName";
    /**
     * MIF client user password
     */
     ...
     */
    public static final String MIF_CLIENT_PROTOCOLS = "connector.jschInvoker.protocols";
    ...
    public static final String MIF_CORE_TEST_CONTEXT = "/spring/mif-core-test.properties";
    ...
    public final static List<String> getPropertyNames() {
        final Field[] declaredFields = MIFTestProperties.class.getDeclaredFields();
